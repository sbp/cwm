#! /bin/bash
# $Id: retest.sh,v 1.7 2001-05-21 11:27:48 timbl Exp $
...
#  (python ../cwm.py $args | sed -e 's/^ *#.*//' | sed -e 's/\$Id: retest.sh,v 1.7 2001-05-21 11:27:48 timbl Exp $//g' > temp/$case) || echo CRASH $case
  (python ../cwm.py -quiet $args | sed -e 's/\$Id: retest.sh,v 1.7 2001-05-21 11:27:48 timbl Exp $//g' > temp/$case) || echo CRASH $case
