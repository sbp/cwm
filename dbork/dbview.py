...
__version__ = "$Id: dbview.py,v 1.13 2002-03-07 00:24:43 connolly Exp $" #@@consult python style guide
...
class DBViewHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def getUI(self):
        ...
        self.wfile.write("""
        <address>Dan C@@ $Revision: 1.13 $ $Date: 2002-03-07 00:24:43 $</address>
        </body></html>
        """)
