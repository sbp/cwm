...
__version__ = "$Id: dbview.py,v 1.15 2002-03-08 00:11:36 connolly Exp $" #@@consult python style guide
...
class DBViewHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def getUI(self):
        ...
        self.wfile.write("""
        <address>Dan C@@ $Revision: 1.15 $ $Date: 2002-03-08 00:11:36 $</address>
        </body></html>
        """)
