...
__version__ = "$Id: dbview.py,v 1.14 2002-03-07 23:25:01 connolly Exp $" #@@consult python style guide
...
class DBViewHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def getUI(self):
        ...
        self.wfile.write("""
        <address>Dan C@@ $Revision: 1.14 $ $Date: 2002-03-07 23:25:01 $</address>
        </body></html>
        """)
