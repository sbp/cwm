...
__version__ = "$Id: dbview.py,v 1.16 2002-03-08 06:45:24 connolly Exp $" #@@consult python style guide
...
class DBViewHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def getUI(self):
        ...
        self.wfile.write("""
        <address>Dan C@@ $Revision: 1.16 $ $Date: 2002-03-08 06:45:24 $</address>
        </body></html>
        """)
